...
import { addLecture, editLecture } from '../../Redux/Slices/lectureSlice';
...
function EditLecture() {
  ...
  useEffect(() => {
    if (singleCourse && singleCourse.lectures) {
      const lecture = singleCourse?.lectures.find(
  ...
  async function handleSubmit(e) {
    ...
    const res = await dispatch(editLecture({ data: formData, courseId , lectureId}));
  ...
  return (
    <div className="w-full flex min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white justify-center py-5">
      <div className="w-full max-w-5xl mx-auto bg-gray-800 p-12 rounded-lg shadow-xl text-white">
        <h2 className="text-4xl font-semibold mb-8 text-center">Edit Lecture</h2>
